...
30DaysOfPython/
‚îú‚îÄ‚îÄ Day01/
‚îÇ   ‚îî‚îÄ‚îÄ introduction.py
‚îú‚îÄ‚îÄ Day02/
‚îÇ   ‚îî‚îÄ‚îÄ variables_and_functions.py
‚îú‚îÄ‚îÄ Day03/
‚îÇ   ‚îî‚îÄ‚îÄ operators.py
...
‚îî‚îÄ‚îÄ README.md
Ìª†Ô∏è Tools and Resources
Language: Python 3.x
